    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col px-6 xl:px-0 sm:px-16`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          <img src={discount} alt="discount" className="w-[32px] h-[32px] hue-rotate-[200deg]" />
      ...
      <div className={`flex-1 ${styles.flexCenter} md:my-0 my-10 relative`}>
        <div className="gradient-mask"><img src={robot} alt="Billing" className="w-full h-full relative z-[5] " /></div>
